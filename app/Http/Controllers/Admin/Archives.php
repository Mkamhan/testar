...
class Archives extends Controller
{
             ...
             */
            public function index(ArchivesDataTable $archives)
            {
               return $archives->render('admin.archives.index',['title'=>trans('admin.archives')]);
            }
            ...
            {
               return view('admin.archives.create',['title'=>trans('admin.create')]);
            }
            ...
            public function show($id)
            {
                ...
                return view('admin.archives.show',['title'=>trans('admin.show'),'archives'=>$archives]);
            }
            ...
            {
                $archives =  Archiv::find($id);
                return view('admin.archives.edit',['title'=>trans('admin.edit'),'archives'=>$archives]);
            }
