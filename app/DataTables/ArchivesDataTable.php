...
class ArchivesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.archives.buttons.actions')
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 ...
                 'name'=>'section_id',
                 'data'=>'section_id',
                 'title'=>trans('admin.section_id'),
		    ],
				[
                 'name'=>'relevantrepartment_id',
                 'data'=>'relevantrepartment_id',
                 'title'=>trans('admin.relevantrepartment_id'),
		    ],
				[
                 'name'=>'batch_id',
                 'data'=>'batch_id',
                 'title'=>trans('admin.batch_id'),
		    ],
				[
                 'name'=>'supervisor_id',
                 'data'=>'supervisor_id',
                 'title'=>trans('admin.supervisor_id'),
		    ],
