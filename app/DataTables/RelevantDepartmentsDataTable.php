...
class RelevantDepartmentsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.relevantdepartments.buttons.actions')
    ...
    {
        return RelevantDepartment::query();
 ...
 [
	    ...
	    {
	        return 'relevantdepartments_' . time();
	    }
