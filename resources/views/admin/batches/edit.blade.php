						...
						<div class="portlet-title">
								...
								<div class="actions">
										<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('batches/create')}}"
												data-toggle="tooltip" title="{{trans('admin.add')}}  {{trans('admin.batches')}}">
												...
												<div class="modal-dialog">
														<div class="modal-content">
																...
																<div class="modal-body">
																		<i class="fa fa-exclamation-triangle"></i>   {{trans('admin.ask_del')}} {{trans('admin.id')}} ({{$batches->id}}) ؟
																</div>
...
{!! Form::open(['url'=>aurl('/batches/'.$batches->id),'method'=>'put','id'=>'batches','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
