...
Route::post('sections/multi_delete','Admin\sections@multi_delete'); 
				Route::resource('relevantdepartments','Admin\RelevantDepartments'); 
Route::post('relevantdepartments/multi_delete','Admin\RelevantDepartments@multi_delete'); 
				Route::resource('batches','Admin\Batches'); 
Route::post('batches/multi_delete','Admin\Batches@multi_delete'); 
				Route::resource('supervisores','Admin\Supervisores'); 
Route::post('supervisores/multi_delete','Admin\Supervisores@multi_delete'); 
				Route::resource('archives','Admin\Archives'); 
Route::post('archives/multi_delete','Admin\Archives@multi_delete'); 
